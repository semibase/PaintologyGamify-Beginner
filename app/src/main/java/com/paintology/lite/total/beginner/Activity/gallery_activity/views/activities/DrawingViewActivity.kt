package com.paintology.lite.total.beginner.Activity.gallery_activity.views.activities
...
import com.paintology.lite.total.beginner.Activity.Lists.challengeLevelList
import com.paintology.lite.total.beginner.Activity.favourite.DrawingRepository
import com.paintology.lite.total.beginner.Activity.gallery_activity.adapter.CommentsAdapter
import com.paintology.lite.total.beginner.Activity.gallery_activity.adapter.TagAdapter
import com.paintology.lite.total.beginner.Activity.gallery_activity.model.Comment
...
import com.paintology.lite.total.beginner.Activity.utils.Constants_Gallery
import com.paintology.lite.total.beginner.Activity.utils.getUserOnlineStatus
import com.paintology.lite.total.beginner.Activity.utils.getUserProfileData
import com.paintology.lite.total.beginner.Activity.utils.hide
import com.paintology.lite.total.beginner.Activity.utils.hideKeyboard
import com.paintology.lite.total.beginner.Activity.utils.invisible
import com.paintology.lite.total.beginner.Activity.utils.onSingleClick
import com.paintology.lite.total.beginner.Activity.utils.onSingleClick1
import com.paintology.lite.total.beginner.Activity.utils.openActivity
import com.paintology.lite.total.beginner.Activity.utils.show
import com.paintology.lite.total.beginner.Activity.utils.showPopupMenu
import com.paintology.lite.total.beginner.Activity.utils.showToastRelease
import com.paintology.lite.total.beginner.Activity.utils.startDrawingActivity
import com.paintology.lite.total.beginner.Activity.utils.startDrawingActivityWithRank
...
import com.paintology.lite.total.beginner.challenge.ChallengeLevelsModel
import com.paintology.lite.total.beginner.challenge.adapter.ChallengeLevelsAdapter
import com.paintology.lite.total.beginner.challenge.adapter.LevelClick
...
import com.paintology.lite.total.beginner.databinding.ActivityDrawingViewBinding
import com.paintology.lite.total.beginner.databinding.LayoutBottomSheetChallengeBinding
import com.paintology.lite.total.beginner.util.FireUtils
import com.paintology.lite.total.beginner.util.KGlobal
import com.paintology.lite.total.beginner.util.SpecingDecoration
import com.paintology.lite.total.beginner.util.StringConstants
import com.paintology.lite.total.beginner.util.sendUserEventWithParam
import java.io.File
                ...
                imgMenuDrawing.showPopupMenu(R.menu.drawing_screen_menu) {
                    ...
                    when (it.itemId) {
                        ...
                        R.id.addFav -> {
                            ...
                            val newDraw:com.paintology.lite.total.beginner.Activity.favourite.NewDrawing =
                                com.paintology.lite.total.beginner.Activity.favourite.NewDrawing(
                                    model.author,
                                    model.createdAt,
                                    model.description,
                                    model.id,
