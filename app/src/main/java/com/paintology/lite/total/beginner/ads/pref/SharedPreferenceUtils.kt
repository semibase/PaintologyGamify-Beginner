package com.paintology.lite.total.beginner.ads.pref
...
class SharedPreferenceUtils(private val sharedPreferences: SharedPreferences) {
    ...
    internal val INTER_SPLASH_KEY = "interOnOff_tb"
    internal val BANNER_DASHBOARD_KEY = "bannerOnOff_tb"
    internal val NATIVE_COMMUNITY_KEY = "nativeOnOff_tb"
    internal val interRewardNotification = "interRewardOnOff_tb"
    internal val openApp = "openAdOnOff_tb"
    internal val interIDs = "interIDs_tb"
    internal val admobAppID = "admobAppID_tb"
    internal val interRewardIDs = "interRewardIDs_tb"
    internal val interProgressActivityRewardIDs = "interProgressActivityRewardIDs_tb"
    internal val interUserPointActivityRewardIDs = "interUserPointActivityRewardIDs_tb"
    internal val nativeIDs = "nativeIDs_tb"
    internal val bannerIDs = "bannerIDs_tb"
    internal val openAppIDs = "openAdID_tb"
